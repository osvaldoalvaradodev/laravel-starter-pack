...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" style="height: 100%">
    ...
    <body class="h-100 d-flex justify-content-center align-items-center" style="background: none">
                ...
                <div class="col-12 col-sm-6 p-0">
                    <div class="card-body ">
                        <form action="{{url('sesion/login')}}" method="POST">
                            {{ csrf_field() }}
                            <h4 class="card-title" align="center" style="color:#25bae9">Iniciar Sesión</h4>
                            <div class="mb-3">
                            ...
                            <div class="mb-2"><a href="#" class="link-light" style="font-size: 0.8rem">recuperar contraseña</a></div>
